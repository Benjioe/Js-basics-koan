...
//       assert.deepEqual(multiTypeArray[3], REPONSE);
//     });
...
//       assert.deepEqual(array.slice(0, 1), REPONSE);
//       assert.deepEqual(array.slice(0, 2), REPONSE);
//       assert.deepEqual(array.slice(2, 2), REPONSE);
//       assert.deepEqual(array.slice(2, 20), REPONSE);
//       assert.deepEqual(array.slice(3, 0), REPONSE);
//       assert.deepEqual(array.slice(3, 100), REPONSE);
//       assert.deepEqual(array.slice(5, 1), REPONSE);
//     });
...
//       assert.deepEqual(array, REPONSE);
